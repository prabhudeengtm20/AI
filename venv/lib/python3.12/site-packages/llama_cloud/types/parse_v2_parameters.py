...
class InputOptionsImage(BaseModel):
    """Image parsing options (applies to .jpg, .jpeg, .png, .webp files)"""

    camera_photo_correction: Optional[bool] = None
...
class InputOptions(BaseModel):
    ...
    image: Optional[InputOptionsImage] = None
    """Image parsing options (applies to .jpg, .jpeg, .png, .webp files)"""
...
class ProcessingOptionsAutoModeConfigurationParsingConf(BaseModel):
    ...
    version: Union[Literal["latest", "2026-09-07", "2026-08-19", "2026-06-15"], str, None] = None
...
class ParseV2Parameters(BaseModel):
    ...
    version: Union[Literal["latest", "2026-09-07", "2026-08-19", "2026-06-15"], str]
